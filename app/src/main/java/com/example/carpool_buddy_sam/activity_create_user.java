...
public class activity_create_user extends AppCompatActivity {
    ...
    private void setupSpinner() {
        ...
        ArrayAdapter<String> langArrAdapter = new ArrayAdapter<String>(activity_create_user.this,
                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if(task.isSuccessful()) {
                            ...
                            Toast.makeText(activity_create_user.this,"Sign up failed", Toast.LENGTH_LONG).show();
                            updateUI(null);
                        }
                    }
                });
